...
*   🛡️ **Tự động phát hiện Look-Ahead Bias:** Cảnh báo đỏ ngay lập tức tại hàm đăng ký chỉ báo `self.I()` nếu phát hiện chỉ báo vô tình tham chiếu dữ liệu tương lai. Hỗ trợ bỏ qua kiểm tra bằng `check_lookahead=False` để tăng tốc độ trong quá trình tối ưu hóa tham số.
